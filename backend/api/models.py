...
class Movies(models.Model):
    ...
    def get_same_genres(self):
        ...
        if self.genre_1 is not "":
            ...
            random_genre_1_movies = genre1_movies[:5]
        ...
        if self.genre_2 is not "":
            ...
            random_genre_2_movies = genre2_movies[:5]
        ...
        if self.genre_3 is not "":
            ...
            random_genre_3_movies = genre3_movies[:5]
    ...
    def get_same_actors(self):
        ...
        if self.actor_1 is not "":
            ...
            random_actor_1_movies = actor_1_movies[:5]
        ...
        if self.actor_2 is not "":
            ...
            random_actor_2_movies = actor_2_movies[:5]
        ...
        if self.actor_3 is not "":
            ...
            random_actor_3_movies = actor_3_movies[:5]
    ...
    def get_same_directors(self):
        ...
        if self.director_1 is not "":
            ...
            random_director_1_movies = director_1_movies[:5]
        ...
        if self.director_2 is not "":
            ...
            random_director_2_movies = director_2_movies[:5]
        ...
        if self.director_3 is not "":
            ...
            random_director_3_movies = director_3_movies[:5]
